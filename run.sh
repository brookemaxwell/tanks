./bin/bzrflag --world=maps/twoteams.bzw --friendly-fire --red-port=50100 --green-port=50101 --purple-port=50102 --blue-port=50103 $@ &
sleep 2 
#python bzagents/dumb_agent.py localhost 50100 &
python bzagents/ian_dumb_agent.py localhost 50100
